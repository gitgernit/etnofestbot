...
def end():
    return (f'Кодовое слово проверено: теперь мне осталось лишь его расшифровать, и я скажу, куда идут все дороги.\n'
            f'Ну-ка, ну-ка... "Все дороги ведут в кафе 47 кабинета"! Отлично. Иди туда и забери свой приз. Твой код: '
